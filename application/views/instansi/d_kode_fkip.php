		...
		<div class="panel panel-info">
			<div class="panel-heading">
				<div class="navbar-header">
					<b class="navbar-brand"><i class="fa fa-th-large"> </i> &nbsp; Kode Fakultas KIP</b>
				</div>
    ...
    <div class="modal-content">
		<form id="form-modal" action="#" method="post">
			<div class="modal-header">
			  ...
			  <h4 class="modal-title" id="myModalLabel">Kode Fakultas KIP</h4>
			</div>
...
function isi_fkip(id, id_parent, nama, kode, aksi) {
	...
	$("#nama").val(nama);
    $("#kode").val(kode);    
	$("#form-modal").attr('action','<?=base_url();?>instansi/kode_fak_kip/' + aksi);    
	$("#nama").focus();
}
</script>