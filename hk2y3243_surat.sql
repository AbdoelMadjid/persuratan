...
-- Dumping data for table hk2y3243_surat.disposisi: 4 rows
...
-- Dumping data for table hk2y3243_surat.disposisi_tanggapan: 4 rows
...
-- Dumping data for table hk2y3243_surat.instansi: ~0 rows (approximately)
...
-- Dumping data for table hk2y3243_surat.menu: 11 rows
DELETE FROM `menu`;
...
INSERT INTO `menu` (`id`, `sub_dari`, `nama`, `url`, `icon`) VALUES
	...
	(14, 'instansi', 'Kode Fakultas KIP', 'kode_fak_kip', 'envelope-o');
...
-- Dumping data for table hk2y3243_surat.pengguna: 53 rows
...
INSERT INTO `pengguna` (`id`, `id_unit`, `nama`, `nomor_induk`, `jabatan`, `jenjang`, `username`, `password`, `tgl_aktif`, `status`, `level`, `apps`, `id_kode_fkip`, `id_menu`, `email`, `ttd_image`, `kehadiran_status`, `kehadiran_keterangan`) VALUES
	(1, '', 'Hely Kurniawan', '11', 'Admin E-Persuratan', 'S1', 'admin', 'e10adc3949ba59abbe56e057f20f883e', '2014-05-20 09:10:20', 'Y', 'admin root', 'instansi', NULL, '1,2,9,13,14,', 'helykurniawan@gmail.com', '1f53738431bd77296ed51e2a9b787dab.jpg', 'keluar', ''),
	(7, '02', 'Prof. Dr. M. Rusdi, M.Sc', '197012191994031005', 'Dekan FKIP', 'S1', '197012191994031005', 'e10adc3949ba59abbe56e057f20f883e', '2014-05-27 08:29:55', 'Y', 'pimpinan', 'surat', NULL, '3,4,5,6,7,', 'rusdi@gmail.com', '1f53738431bd77296ed51e2a9b787dab.jpg', 'hadir', 'HADIR OK'),
	...
	(54, '', 'Admin Surat FKIP', '-', 'Tata Usaha', 'S1', 'adm_surat', 'e10adc3949ba59abbe56e057f20f883e', '2014-10-17 09:38:17', 'Y', 'tata usaha', 'surat', 7, '3,4,7,12,', 'admn@yahoo.com', 'blank.jpg', 'hadir', ''),
...
-- Dumping data for table hk2y3243_surat.r_jenis_surat: 3 rows
...
-- Dumping data for table hk2y3243_surat.surat_keluar: 4 rows
...
INSERT INTO `surat_keluar` (`id`, `id_rel_surat_masuk`, `id_rel_disposisi`, `pengirim`, `pengirim_user`, `tgl_surat`, `no_agenda`, `no_surat`, `penerima`, `perihal`, `kecepatan`, `pemeriksa`, `pemeriksa_user`, `paraf_list`, `flag_setuju`, `flag_keluar`, `flag_del`, `flag_revisi`, `tipe`, `id_buat_surat`, `file`, `id_jenis_surat`, `isi_surat`, `id_kode_hal_org`, `catatan`) VALUES
	(12, 0, 0, '020202', 33, '2014-10-28', '00001', '01/02/SK/2014', 'Dekan FKIP', 'Tugas Belajar', 'sangat segera', '02', 7, NULL, 'Y', 'Y', 'N', 'N', 'file', 0, 'Catatan_E-PERSURATAN1.docx', 1, '<p>Pengusulan Surat Tugas test</p>', 4, ''),
	...
	(23, 0, 0, '', 54, '2014-11-15', '00005', '023/UN21.1.2.1/AKJ/2014', 'penerima', 'perihal', 'sangat segera', '02', 7, '20,15,', 'Y', 'Y', 'N', 'N', 'file', 0, '', 1, '<p>isi surat update paling baru</p>', 3, 'last catatan');
/*!40000 ALTER TABLE `surat_keluar` ENABLE KEYS */;


-- Dumping structure for table hk2y3243_surat.surat_keluar_revisi
...
-- Dumping data for table hk2y3243_surat.surat_keluar_revisi: ~1 rows (approximately)
...
-- Dumping data for table hk2y3243_surat.surat_masuk: 2 rows
...
INSERT INTO `surat_masuk` (`id`, `tgl_diterima`, `tgl_surat`, `pengirim`, `nomor`, `no_agenda`, `penerima`, `tembusan`, `perihal`, `kecepatan`, `file`, `flag_read`, `flag_del`, `flag_lanjut`, `flag_tolak`, `alasan`) VALUES
	(10, '2014-10-20 20:02:37', '2014-10-20', 'UNJ', '01/DT/2014', '000001', '02', '', 'Undangan Seminar ICETS', 'sangat segera', 'ICETS_Paper_Template.pdf', 'Y', 'Y', 'Y', 'N', ''),
...
-- Dumping data for table hk2y3243_surat.unit: 40 rows
DELETE FROM `unit`;
